...
public class OtpUpdateProfileAdmin extends AppCompatActivity {
    CheckBox male,female,student,working;
    EditText name, address, pincode;
    Button save, skip;
    FirebaseAuth auth;
    FirebaseFirestore dbroot;
    String userID,imageurl,month,sex,profession,phoneNo,name2,profession2,sex2,pincode2,phone2,address2,imageurl2;
    Fragment  temp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(OtpUpdateProfile.this, new OnCompleteListener<AuthResult>() {
        // @Override
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(name1) || TextUtils.isEmpty(address1)||TextUtils.isEmpty(pin)) {
                    Toast.makeText(OtpUpdateProfileAdmin.this, "please add details ", Toast.LENGTH_SHORT).show();
                } else if (pin.length() != 6) {
                    Toast.makeText(OtpUpdateProfileAdmin.this, "pin code must be  of 6 digit No.", Toast.LENGTH_SHORT).show();
                } else {
                    auth = FirebaseAuth.getInstance();
                    //progressBar.setVisibility(View.VISIBLE);
                    // auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(OtpUpdateProfile.this, new OnCompleteListener<AuthResult>() {
...
//                        finish();
                    ...
                    documentReference.set(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(Task<Void> task) {
                            ...
                            Toast.makeText(OtpUpdateProfileAdmin.this, "Details updated successfully", Toast.LENGTH_SHORT).show();
...
//                        Toast.makeText(getApplicationContext(), "data saved", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.INVISIBLE);
                    startActivity(new Intent(getApplicationContext(),ViewCustomerPlan.class));
                    finish();
                    //}
...
//                        Toast.makeText(getApplicationContext(), "data saved", Toast.LENGTH_SHORT).show();
                                ...
                                startActivity(new Intent(getApplicationContext(),CustomCalendar.class));
                                finish();
                                // Toast.makeText(OtpUpdateProfile.this, "Toast...", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                });
