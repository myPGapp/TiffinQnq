...
public class UsersByVendorId extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
//        System.out.println(list2.get(1));
        adapter = new ArrayAdapter<String>(UsersByVendorId.this, android.R.layout.simple_spinner_item,list2);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent=new Intent(this,VendorIdSpinner.class);
