...
public class Adapterpayment extends RecyclerView.Adapter<Adapterpayment.myviewholder> {
    ArrayList<Modelpayment> data;
    private Context context;
    public Adapterpayment(Context context,ArrayList<Modelpayment> data) {
    ...
    public Adapterpayment.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new Adapterpayment.myviewholder(view);

    }
    @Override
    public void onBindViewHolder(final Adapterpayment.myviewholder holder, @SuppressLint("RecyclerView") int position) {
