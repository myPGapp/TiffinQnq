...
public class Adapterother extends RecyclerView.Adapter<Adapterother.myviewholder> {
    ArrayList<Modelother> data;
    private Context context;
    public Adapterother(Context context,ArrayList<Modelother> data) {
    ...
    @Override
    public Adapterother.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.singlerowdelivery,parent,false);
        return new Adapterother.myviewholder(view);

    }
    @Override
    public void onBindViewHolder(final Adapterother.myviewholder holder, @SuppressLint("RecyclerView") int position) {
