...
public class ComplaintDelivery extends AppCompatActivity {
...
String imageurl,userID,edtdescription,name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complaint_delivery);
        ...
        btnpost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(edtdescription.isEmpty()){
                    Toast.makeText(ComplaintDelivery.this, "Please add description first", Toast.LENGTH_SHORT).show();
                }else {
                    progressBar.setVisibility(View.VISIBLE);
                    DocumentReference docIdRef = fstore.collection("users").document(userID);
                    docIdRef.collection("complaints").document("food delivery").
                            collection("Food Delivery").document().set(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {

                                     Toast.makeText(ComplaintDelivery.this, "Complaints submitted successfully", Toast.LENGTH_SHORT).show();
