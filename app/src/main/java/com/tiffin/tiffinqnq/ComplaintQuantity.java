...
public class ComplaintQuantity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complaint_quantity);
        ...
        btnpost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(edtdescription.isEmpty()){
                    Toast.makeText(ComplaintQuantity.this, "Please add description first", Toast.LENGTH_SHORT).show();
                }else {
                    progressBar.setVisibility(View.VISIBLE);
                    DocumentReference docIdRef = fstore.collection("users").document(userID);
                    docIdRef.collection("complaints").document("food quantity").
                            collection("Food Quantity").document().set(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
                                public void onComplete(@NonNull Task<Void> task) {
                                    Toast.makeText(ComplaintQuantity.this, "Complaints submitted successfully", Toast.LENGTH_SHORT).show();
                                    Intent intent=new Intent(getApplicationContext(),MainActivity.class);
                                    startActivity(intent);
                                    finish();
                                    progressBar.setVisibility(View.INVISIBLE);
                                    //Toast.makeText(ComplaintQuantity.this, "done..", Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
