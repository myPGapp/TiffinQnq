...
public class Adapterquantity extends RecyclerView.Adapter<Adapterquantity.myviewholder> {
    ArrayList<Modelquantity> data;
    private Context context;
    public Adapterquantity(Context context,ArrayList<Modelquantity> data) {
    ...
    @Override
    public Adapterquantity.myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.singlerowdelivery,parent,false);
        return new Adapterquantity.myviewholder(view);

    }
    @Override
    public void onBindViewHolder(final Adapterquantity.myviewholder holder, @SuppressLint("RecyclerView") int position) {
