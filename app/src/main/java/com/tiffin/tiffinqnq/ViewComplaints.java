...
public class ViewComplaints extends AppCompatActivity implements ProfileInterface{
   ...
   TextView username;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username.setText("Complaints of "+ System.getProperty("line.separator") +name);
